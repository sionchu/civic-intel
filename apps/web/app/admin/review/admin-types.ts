...
export type QueueItem = OperatorRecord & { disposition: string; linked_person_id: string | null; link_action: string | null; link_decision_class: string | null; candidate_count: number; candidates: { id: string; canonical_name: string; identity_status: string }[] };
