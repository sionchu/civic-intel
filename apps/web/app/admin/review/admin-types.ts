...
export type AdminReceipt = { id: string; actor: string; action: string; created_at: string; reason: string; changes: AdminChange[]; result: { outcomes: Record<string, unknown>[]; changed_rows: number }; write_performed: boolean; replayed: boolean };
