...
Implemented the real ALIO review workload, 12 explicit admin commands, signed preview/confirmation,
atomic append-only receipts and published exact Person–Organization roles. Full local regression
552 passed / 1 skipped, Golden passed; final focused admin suite 22 passed. Synthetic PostgreSQL
link/merge/idempotency proof passed. Browser admin mutation QA passed 17 checks before final polish.
Actual staging backup restored on local PostgreSQL18.6 and 0006->0007->0006->0007 verified without
changing original staging data. The restored named queue has 3624 unreviewed records and 3076
name strings; neither figure is a count of newly registered unique People.

## Next concrete action

Close final browser/diff review, submit the coherent PR and require GitHub Verify. Then validate
the existing automatic staging migration/deployment and activate the private admin session for the
operator. No real person registration/merge/deactivation is authorized as a test action.
