...
overriding them. `exec-plans/active/` contains only currently approved long-running implementation
...
- [National Assembly roster to Evidence Directory](exec-plans/completed/assembly-roster-evidence-directory.md)
- [Assembly Person Bootstrap v1](exec-plans/completed/assembly-person-bootstrap-v1.md)
- [Assembly reviewed distinct-Person resolution v1](exec-plans/completed/assembly-reviewed-distinct-person-v1.md)
- [Evidence Directory site v1](exec-plans/completed/evidence-directory-site-v1.md)
- [People Discovery UX v1](exec-plans/completed/people-discovery-ux-v1.md)
- [Visual System v2](exec-plans/completed/visual-system-v2.md)
- [Portrait Source Gate v0](exec-plans/completed/portrait-source-gate-v0.md)
- [Portrait Pilot v0](exec-plans/completed/portrait-pilot-v0.md)
...
- [ALIO reviewed Organization binding workflow v0](exec-plans/completed/alio-reviewed-organization-binding-workflow-v0.md)
- [Organization Evidence page v0](exec-plans/completed/organization-evidence-page-v0.md)
- [Evidence Preview v1 active execution plan](exec-plans/completed/evidence-preview-v1.md)
...
- [ALIO Item 12 Claim-backed MONEY projection v0 plan](exec-plans/completed/alio-item12-claim-backed-money-projection-v0.md)
- [Role model and subagent coordination](roles/ROLE_MODEL.md)
- [Project-scoped Codex agent adapters](../.codex/agents/)
...
- [Completed batch-ingestion L3 plan](exec-plans/completed/batch-ingestion-l3.md)
- [Codex entrypoint for the batch foundation](exec-plans/completed/batch-ingestion-l3-codex.md)
- [Completed NEC local-winner L3 plan](exec-plans/completed/nec-local-winners-l3.md)
- [Completed Assembly bill-participation L3 plan](exec-plans/completed/assembly-bill-participation-l3.md)
- [Assembly Member Profile Substance v1](exec-plans/completed/assembly-member-profile-substance-v1.md)
- [Completed NEC local-candidate L3 plan](exec-plans/completed/nec-local-candidates-l3.md)
- [Completed ALIO public-institution executives L3 plan](exec-plans/completed/alio-public-institution-executives-l3.md)
- [ALIO Organization & Executive Content Activation v1](exec-plans/completed/alio-organization-executive-content-activation-v1.md)
- [ALIO Organization Content Staging Activation v1](exec-plans/blocked/alio-organization-content-staging-activation-v1.md)
- [ALIO Organization Claim Batch-Write v1](exec-plans/completed/alio-organization-claim-batch-write-v1.md)
- [First live staging ALIO Organization publication v1](exec-plans/completed/alio-organization-live-staging-publication-v1.md)
- [C0908 identity acceptance contract v1](exec-plans/completed/c0908-identity-acceptance-contract-v1.md)
...
- [org.go Reviewed Organization Materialization v0](exec-plans/completed/orggo-reviewed-organization-materialization-v0.md)
...
- [Government Public Ethics Committee retired-public-official employment-review source-gate plan](exec-plans/blocked/government-public-ethics-employment-review-l3.md)
